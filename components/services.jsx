            ...
            return (
              <Reveal key={s.id} delay={i * 60}>
                <div
                  ...
                  style={{
                    display: 'grid',
                    gridTemplateColumns: '60px 60px 1.3fr 2fr 120px',
                    gap: 48,
                    alignItems: 'center',
                    padding: '48px 0',
  ...
  return (
    <main style={{ paddingTop: 140 }}>
      <div className="container">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.3fr', gap: 96, marginBottom: 96, alignItems: 'end' }}>
          <div>
            <Reveal>
        ...
        {/* Coverage / SLA strip */}
        <Reveal>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', borderTop: '1px solid var(--fg-15)', borderBottom: '1px solid var(--fg-15)', marginBottom: 96 }}>
...
Object.assign(window, { ServicesPage, ServiceDetailPage, FleetTierSelector });
