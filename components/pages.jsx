  ...
  return (
    <main style={{ paddingTop: 140 }}>
      <div className="container">
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 72, alignItems: 'end', marginBottom: 120 }}>
          <div>
        ...
        <div style={{ position: 'relative', paddingLeft: 0 }}>
          {phases.map((p, i) => (
            <Reveal key={p.n} delay={i * 80}>
              <div style={{ display: 'grid', gridTemplateColumns: '120px 1fr 1.5fr 1fr', gap: 48, padding: '72px 0', borderTop: '1px solid var(--fg-15)', alignItems: 'start' }}>
                <div>
        ...
        <section className="section">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: 0, border: '1px solid var(--fg-08)' }}>
            {[
          ...
          <div style={{ position: 'sticky', top: 140 }}>
            ...
            <div className="mt-48">
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                {[
                  { icon: 'Phone', label: '+382 32 500 012', sub: 'Operational desk · 24h in season' },
                  { icon: 'Mail', label: 'ops@yachtconcierge.me', sub: 'Encrypted channel available on request' },
                  { icon: 'Pin', label: 'Porto Montenegro, Obala br. 1', sub: 'Tivat 85320 · Montenegro' },
                ].map(c => {
          ...
          <div style={{ border: '1px solid var(--fg-15)', padding: 56, background: 'var(--bg-raised)' }}>
            ...
            {step < 5 && (
              <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 48, paddingTop: 32, borderTop: '1px solid var(--fg-15)' }}>
                ...
                >
                  {step === 4 ? 'Submit Brief' : 'Continue'} <Icons.Arrow size={14}/>
                </button>
              </div>
            )}
          </div>
...
function FleetPage() {
  return (
    <main style={{ paddingTop: 140 }}>
      <div className="container">
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 72, alignItems: 'end', marginBottom: 96 }}>
          <div>
...
Object.assign(window, { ProcessPage, ContactPage, FleetPage });
