  ...
  return (
    <main style={{ paddingTop: 140 }}>
      <div className="container">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 72, alignItems: 'end', marginBottom: 80 }}>
          <div>
        ...
        <div className="shop-mobile-filters" style={{ display: 'none', marginBottom: 24 }}>
        ...
        {/* Main grid */}
        <div className="shop-layout" style={{ display: 'grid', gridTemplateColumns: '260px 1fr', gap: 56, alignItems: 'start' }}>
          {/* Filters sidebar */}
          <aside className="shop-filters" style={{ position: 'sticky', top: 120, display: filtersMobile || window.innerWidth > 900 ? 'block' : 'block' }}>
...
function OrderSummaryPage() {
  ...
  return (
    <main style={{ paddingTop: 140 }}>
      <div className="container">
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 72, alignItems: 'end', marginBottom: 72 }}>
          <div>
        ...
        {confirmed ? (
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr', gap: 56, alignItems: 'start' }}>
            ...
            <aside style={{ position: 'sticky', top: 120, border: '1px solid var(--fg-15)', padding: 32, background: 'var(--bg-raised)' }}>
              ...
              <button
                onClick={() => { console.log('ORDER PLACED', { ref: refNum, items: cart.cart, meta: cart.meta, total }); setConfirmed(true); window.scrollTo({ top: 0 }); }}
                className="btn btn-primary mt-32"
                style={{ width: '100%', justifyContent: 'center' }}
              >
                Confirm & Place Order <Icons.Arrow size={14}/>
              </button>
...
Object.assign(window, { ProvisioningPage, OrderSummaryPage });
