...
function ProcessStrip() {
  ...
  return (
    <section className="section" style={{ background: 'var(--bg-warm)' }}>
      <div className="container">
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 72, marginBottom: 72, alignItems: 'end' }}>
          <div>
...
Object.assign(window, { CoastMap, Testimonial, ProcessStrip, ClosingCTA, HomePage });
