  ...
  return (
    <div className="logo" onClick={onClick} aria-label="Yacht Concierge">
      ...
      <div className="logo-text">
        ...
        <div className="logo-text-sub">MONTENEGRO · EST. MMXIX</div>
      </div>
    </div>
  );
}
      ...
      <div className="container">
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: 48, marginBottom: 64 }}>
          ...
          {[
            ...
            { title: 'Office', items: ['Porto Montenegro', 'Obala br. 1', 'Tivat 85320', '+382 32 500 012', 'ops@yachtconcierge.me'] },
          ].map(col => (
            <div key={col.title}>
        ...
        <div className="rule" />
        <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 28, fontFamily: 'var(--mono)', fontSize: 10, letterSpacing: '0.2em', textTransform: 'uppercase', color: 'var(--fg-50)' }}>
          <span>© MMXXVI YACHT CONCIERGE D.O.O.</span>
          <span>ISO 9001 · MYBA · MLC 2006</span>
...
Object.assign(window, { Icons, Icon, Logo, Nav, Footer, Reveal, useReveal, SectionHeader, AppCtx, useApp });
