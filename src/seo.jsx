...
const SEO_DATA = {
  ...
  legal: {
    ...
    description: 'Legal notice, company details, and dispute resolution information for Yacht Concierge Montenegro, Tivat.',
  ...
  privacy: {
    ...
    description: 'How Yacht Concierge Montenegro collects, processes, and protects personal data in accordance with GDPR and Montenegrin data protection law.',
  ...
  terms: {
    ...
    description: 'Terms and conditions governing superyacht concierge and logistics services provided by Yacht Concierge Montenegro.',
