export const SERVICES = [
  ...
  { id: 'laundry',      num: '04', title: 'Laundry & Linen',           icon: 'Droplet', desc: 'Professional marine laundry. Guest linen, crew uniforms, deck towels — tracked, next-day return on standard items.' },
