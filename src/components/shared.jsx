    ...
    <footer style={{ borderTop: '1px solid var(--fg-08)', padding: '72px 0 40px', marginTop: 80 }}>
      <div className="container">
        <div className="grid-footer" style={{ gap: 48, marginBottom: 64 }}>
          ...
          <div>
            <div className="mono" style={{ color: 'var(--fg-50)', marginBottom: 18 }}>Office</div>
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 10 }}>
...
export { AppCtx, useApp, Icons, Icon, Logo, Nav, Footer, Reveal, useReveal, SectionHeader, WhatsAppFloat };
